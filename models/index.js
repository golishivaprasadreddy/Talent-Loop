...
const UserSchema = new Schema({
  ...
  avatar: String, phone: String, about: String, skills: [String], experience: [Schema.Types.Mixed], education: [Schema.Types.Mixed], certifications: [String], languages: [String], portfolio: { github: String, linkedin: String, website: String }, resumeUrl: String, verified: { type: Boolean, default: false }, suspended: { type: Boolean, default: false },
...
const ApplicationSchema = new Schema({ job: { type: Schema.Types.ObjectId, ref: "Job", required: true }, candidate: { type: Schema.Types.ObjectId, ref: "User", required: true }, name: String, email: String, phone: String, govtId: Schema.Types.Mixed, resumeUrl: String, resumeFileName: String, coverLetter: String, portfolioLink: String, linkedinUrl: String, experience: Schema.Types.Mixed, education: Schema.Types.Mixed, certifications: [String], notes: String, answers: [{ questionId: String, question: String, answer: String }], status: { type: String, enum: ["applied", "under_review", "shortlisted", "interview", "offered", "rejected"], default: "applied" } }, baseOptions);
